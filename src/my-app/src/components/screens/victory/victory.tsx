        ...
        <div className="page" >
            ...
            <div className="column">
                <div className="winner">
                    <img src="./game_sprites/winner.png" id="winner" />
                </div>
                <div className="stage">
                    <Stage width={400} height={710} options={{ backgroundAlpha: 0 }}>
                        {/* <Sprite image={player1.image} scale={ {x: 0.8 , y: 0.8} }/> */}
                        <AnimatedSprite animationSpeed={0.05} isPlaying={true} images={["./game_sprites/char1.png", "./game_sprites/char1frame2.png"]} anchor={0.02} visible={true} />
                        <AnimatedSprite animationSpeed={0.05} isPlaying={false} images={["./game_sprites/char2_frames/char2frame1.png", "./game_sprites/char2_frames/char2frame3.png"]} anchor={0.02} visible={false} />
